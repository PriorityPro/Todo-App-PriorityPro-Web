  ...
  return (
    <li className='p-2 flex items-center'>
      ...
      <div className='inline-flex group '>
        ...
        {/* Trash can icon */}
        <svg id={'trash'} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" onClick={() => { deleteItemFromList(todo.id) }} className="bg-red-500 cursor-pointer w-8 h-8 p-1 m-1 rounded-md shadow-lg dark:shadow-dark">
